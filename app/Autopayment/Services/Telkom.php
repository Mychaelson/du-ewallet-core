...
* 
*/
class Telkom extends Service implements ServiceInterface
{
    public function inquiry()
    {
        ...
        if($res['status'] != 'failed') {
            ...
            $transaction = DigitalTransaction::create([
                ...
                'type' => 1,
                'meta' => [
                    'inquiry' => url('/api/v1/telkom/inquiry'),
                    'payment' => url('/api/v1/telkom/payment')
                ]
            ]);
    ...
    public function payment()
    {
        ...
        if($tr){
            ...
            $params = [
                ...
                'code_area' => $transaction->request_data['code_area'],
            ...
            $transaction->admin_fee = $res['data']['admin_fee'];
