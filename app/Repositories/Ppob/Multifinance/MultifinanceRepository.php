...
namespace App\Repositories\Ppob\Multifinance;
    ...
    public function inquiry($request,$user_id)
    {
        ...
        if($res['status'] != 'failed') {
            ...
            $param = [
                ...
                'type' => 1,
                'meta' => [
                    'inquiry' => 'App\Repositories\Ppob\Multifinance\MultifinanceRepository',
                    // 'payment' => url('/api/multifinance/payment')
                ],
                'payment_information' => []
            ];
