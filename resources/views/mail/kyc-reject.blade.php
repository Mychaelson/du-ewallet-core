...
<html lang="en" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
  <head>
    ...
    <title>{{ $brand }} - Verifikasi Gagal</title>
    <style type="text/css">
      @font-face {
        font-family: 'Ubuntu';
        font-style: normal;
                ...
                <table cellpadding="0" cellspacing="0" role="presentation" class="w-600 sm-w-full" style="width:600px !important;background-color:#fff; border-radius: 10px; -webkit-box-shadow: 0px 2px 4px 0px rgba(0, 0, 0, 0.1); -moz-box-shadow: 0px 2px 4px 0px rgba(0, 0, 0, 0.1); box-shadow: 0px 2px 4px 0px rgba(0, 0, 0, 0.1);">
                  ...
                  <tr>
                    <td class="align-center" colspan="2" style="text-align:center;">
                      <strong class="text-40 color-red bold" style="font-size:40px;line-height:53px;margin:0;font-weight:700;color:#E74C3C !important;">Verifikasi Gagal</strong>
                    </td>
                  </tr>
                  <tr>
                    <td class="align-center center-icon" colspan="2" style="padding:30px 0px;text-align:center;">
                      <img src="{{ $assets }}x-red.png" width="100" height="100" alt="">
                    </td>
                  </tr>
                  <tr>
                    <td colspan="2">
                      <p class="text-25 pb-20 align-center" style="text-align:center;padding-bottom:20px;font-size:25px;line-height:33px;margin:0;">{{ $username }}</p>
                      <p class="text-16 align-center pb-40" style="text-align:center;padding-bottom:40px;font-size:16px;line-height:21px;margin:0;">Pengajuan proses verifikasi anda belum bisa<br>
                        kami terima karena tidak sesuai dengan syarat,<br>
                        mohon untuk memeriksa kembali data anda.<br>Syarat dan ketentuan berlaku.</p>
                    </td>
                  </tr>
                  <tr>
